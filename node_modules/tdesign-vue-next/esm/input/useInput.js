...
import { toRefs, ref, computed, nextTick, inject, watch, onBeforeMount } from 'vue';
...
function useInput(props, expose) {
  ...
  var updateLimitNumber = function updateLimitNumber() {
    if (props.maxcharacter && props.maxcharacter > 0) {
      var len = getCharacterLength(String(innerValue.value));
