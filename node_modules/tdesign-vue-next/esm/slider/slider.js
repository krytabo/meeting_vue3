...
import { formatSlderValue, getStopStyle } from './util/common.js';
...
var _Slider = defineComponent({
  ...
  setup: function setup(props2, ctx) {
    ...
    var firstValue = ref(formatSlderValue(sliderValue.value, "first"));
    var secondValue = ref(formatSlderValue(sliderValue.value, "second"));
    ...
    return function () {
      ...
      }, null), props2.showStep && createVNode("div", null, [steps.value.map(function (item, key) {
        return createVNode("div", {
