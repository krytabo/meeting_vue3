...
var _BaseTable = defineComponent({
  ...
  render: function render() {
    ...
    }, [renderColGroup(), createVNode(THead, headProps, this.$slots)])]);
    ...
    var affixedFooter = Boolean(this.footerAffixedBottom && ((_this$footData = this.footData) === null || _this$footData === void 0 ? void 0 : _this$footData.length) && this.tableWidth) && createVNode(Affix, mergeProps({
      ...
      "default": function _default() {
        ...
        }, [renderColGroup(), createVNode(TFoot, {
          "rowKey": _this.rowKey,
    ...
    }, [renderColGroup(), this.showHeader && createVNode(THead, headProps, this.$slots), createVNode(TBody, tableBodyProps, this.$slots), createVNode(TFoot, {
      "rowKey": this.rowKey,
      "isFixedHeader": this.isFixedHeader,
      "rowAndColFixedPosition": rowAndColFixedPosition,
