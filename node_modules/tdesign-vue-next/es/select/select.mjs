...
import { _ as _objectWithoutProperties } from '../_chunks/dep-d52a3086.mjs';
...
import { i as isArray_1 } from '../_chunks/dep-de110986.mjs';
import { i as isFunction_1 } from '../_chunks/dep-c5944b2d.mjs';
import { d as debounce_1 } from '../_chunks/dep-bd52eb06.mjs';
...
import { getSingleContent, getMultipleContent, getNewMultipleValue, selectInjectKey } from './helper.mjs';
...
var TSelect = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var setInnerValue = function setInnerValue(newVal, e) {
      if (props2.valueType === "object") {
        ...
        var getOption = function getOption(val) {
          ...
          return _ref2 = {}, _defineProperty(_ref2, value2, get_1(option, value2)), _defineProperty(_ref2, label, get_1(option, label)), _ref2;
        };
    ...
    var placeholderText = computed(function () {
      var _ref3;
      return (_ref3 = !props2.multiple && innerPopupVisible.value && getSingleContent(innerValue.value, optionsList.value) || props2.placeholder) !== null && _ref3 !== void 0 ? _ref3 : t(globalConfig.value.placeholder);
    });
    var displayText = computed(function () {
      return props2.multiple ? getMultipleContent(innerValue.value, optionsList.value) : getSingleContent(innerValue.value, optionsList.value);
    });
