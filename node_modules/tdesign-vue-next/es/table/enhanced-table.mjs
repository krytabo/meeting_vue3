...
import { defineComponent, ref, computed, getCurrentInstance, createVNode } from 'vue';
...
import '../_chunks/dep-86610d7f.mjs';
...
var _EnhancedTable = defineComponent({
  ...
  setup: function setup(props, context) {
    ...
    return function () {
      ...
      return createVNode(_PrimaryTable, enhancedProps, context.slots);
    };
  }
});
