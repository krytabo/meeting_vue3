...
export declare const InputNumber: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "max" | "value" | "disabled" | "size" | "readonly" | "step" | "placeholder" | "min" | "modelValue" | "theme" | "autoWidth" | "largeNumber" | "decimalPlaces">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
