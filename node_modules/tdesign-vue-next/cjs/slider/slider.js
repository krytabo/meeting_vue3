...
var _Slider = vue.defineComponent({
  ...
  setup: function setup(props2, ctx) {
    ...
    var firstValue = vue.ref(slider_util_common.formatSlderValue(sliderValue.value, "first"));
    var secondValue = vue.ref(slider_util_common.formatSlderValue(sliderValue.value, "second"));
    ...
    return function () {
      ...
      }, null), props2.showStep && vue.createVNode("div", null, [steps.value.map(function (item, key) {
        return vue.createVNode("div", {
