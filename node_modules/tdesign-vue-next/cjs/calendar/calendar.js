...
var _Calendar = vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var renderControl = function renderControl() {
      ...
      }), _isSlot(_slot = dateSelect.yearSelectOptionList.value.map(function (item) {
      ...
      }), _isSlot(_slot2 = dateSelect.monthSelectOptionList.value.map(function (item) {
        return vue.createVNode(select_index.Option, {
          "key": item.value,
          "value": item.value,
          "label": item.label,
      ...
      }), _isSlot(_slot3 = modeSelect.optionList.value.map(function (item) {
    ...
    var clickCell = function clickCell(e, cellData) {
      state.curDate = dayjs__default["default"](cellData.date);
    ...
    var monthCellsData = vue.computed(function () {
      var daysArr = calendar_utils.createMonthCellsData(state.curSelectedYear, state.curSelectedMonth, state.realFirstDayOfWeek, state.curDate, props2.format);
      return daysArr;
    });
    ...
    var yearCellsData = vue.computed(function () {
      var re = [];
      var monthsArr = calendar_utils.createYearCellsData(state.curSelectedYear, state.curDate, props2.format);
