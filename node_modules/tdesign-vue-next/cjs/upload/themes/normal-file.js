...
var NormalFile = vue.defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var renderFilePreviewAsInput = function renderFilePreviewAsInput() {
      ...
      var fileName = (_props$abridgeName = props.abridgeName) !== null && _props$abridgeName !== void 0 && _props$abridgeName.length && file !== null && file !== void 0 && file.name ? _common_js_upload_utils.abridgeName(file.name, props.abridgeName[0], props.abridgeName[1]) : file === null || file === void 0 ? void 0 : file.name;
      return vue.createVNode("div", {
