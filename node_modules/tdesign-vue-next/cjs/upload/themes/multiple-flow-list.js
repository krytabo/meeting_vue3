...
var MultipleFlowList = vue.defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var renderFileList = function renderFileList() {
      ...
      }, innerDragEvents.value), [vue.createVNode("thead", null, [vue.createVNode("tr", null, [vue.createVNode("th", null, [(_locale$value$file = locale.value.file) === null || _locale$value$file === void 0 ? void 0 : _locale$value$file.fileNameText]), vue.createVNode("th", null, [(_locale$value$file2 = locale.value.file) === null || _locale$value$file2 === void 0 ? void 0 : _locale$value$file2.fileSizeText]), vue.createVNode("th", null, [(_locale$value$file3 = locale.value.file) === null || _locale$value$file3 === void 0 ? void 0 : _locale$value$file3.fileStatusText]), disabled.value ? null : vue.createVNode("th", null, [(_locale$value$file4 = locale.value.file) === null || _locale$value$file4 === void 0 ? void 0 : _locale$value$file4.fileOperationText])])]), vue.createVNode("tbody", null, [!displayFiles.value.length && vue.createVNode("tr", null, [vue.createVNode("td", {
        "colSpan": 4
