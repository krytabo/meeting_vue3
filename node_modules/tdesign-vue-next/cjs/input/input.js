...
var _excluded = ["isHover", "tStatus", "inputRef", "inputPreRef", "renderType", "showClear", "focused", "inputValue", "innerValue", "limitNumber"];
...
var _Input = vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    input_useInputWidth["default"](props2, inputPreRef, inputRef, innerValue);
    ...
    return function () {
      ...
      return vue.createVNode("div", {
        ...
        "class": "".concat(INPUT_TIPS_CLASS.value, " ").concat(classPrefix.value, "-input__tips--").concat(props2.status)
      }, [tips])]);
    };
  }
});
