...
var TSelect = vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var placeholderText = vue.computed(function () {
      var _ref3;
      return (_ref3 = !props2.multiple && innerPopupVisible.value && select_helper.getSingleContent(innerValue.value, optionsList.value) || props2.placeholder) !== null && _ref3 !== void 0 ? _ref3 : t(globalConfig.value.placeholder);
    });
    var displayText = vue.computed(function () {
      return props2.multiple ? select_helper.getMultipleContent(innerValue.value, optionsList.value) : select_helper.getSingleContent(innerValue.value, optionsList.value);
    });
