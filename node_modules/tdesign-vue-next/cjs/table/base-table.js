  ...
  render: function render() {
    ...
    var renderColGroup = function renderColGroup() {
      return vue.createVNode("colgroup", null, [columns.map(function (col) {
        var style = {
          width: table_hooks_useStyle.formatCSSUnit(_this.thWidthList[col.colKey] || col.width) || defaultColWidth
        };
        if (col.minWidth) {
    ...
    }, [renderColGroup(), vue.createVNode(table_thead["default"], headProps, this.$slots)])]);
    ...
    var affixedFooter = Boolean(this.footerAffixedBottom && ((_this$footData = this.footData) === null || _this$footData === void 0 ? void 0 : _this$footData.length) && this.tableWidth) && vue.createVNode(affix_index.Affix, vue.mergeProps({
      ...
      "default": function _default() {
        ...
        }, [renderColGroup(), vue.createVNode(table_tfoot["default"], {
          "rowKey": _this.rowKey,
    ...
    }, [renderColGroup(), this.showHeader && vue.createVNode(table_thead["default"], headProps, this.$slots), vue.createVNode(table_tbody["default"], tableBodyProps, this.$slots), vue.createVNode(table_tfoot["default"], {
      "rowKey": this.rowKey,
      "isFixedHeader": this.isFixedHeader,
      "rowAndColFixedPosition": rowAndColFixedPosition,
    ...
    }, null), bottom, this.horizontalScrollAffixedBottom && renderAffixedHorizontalScrollbar(), this.paginationAffixedBottom ? vue.createVNode(affix_index.Affix, vue.mergeProps({
      "offsetBottom": 0
