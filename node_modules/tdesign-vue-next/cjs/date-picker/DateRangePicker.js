...
require('../_chunks/dep-2d96e007.js');
      ...
      if (visible) {
        ...
        if (!value.value.length) {
          ...
          var nextMonth = value.value.map(function (v) {
            return _common_js_datePicker_format.parseToDayjs(v || new Date(), formatRef.value.format).month();
          });
          ...
          year.value = value.value.map(function (v) {
            return _common_js_datePicker_format.parseToDayjs(v || new Date(), formatRef.value.format).year();
          });
        } else {
          year.value = value.value.map(function (v) {
            return _common_js_datePicker_format.parseToDayjs(v || new Date(), formatRef.value.format).year();
