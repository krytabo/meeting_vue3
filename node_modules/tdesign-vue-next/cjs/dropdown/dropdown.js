...
require('../_chunks/dep-4b994dc5.js');
  ...
  setup: function setup(props2, _ref) {
    ...
    var handleMenuClick = function handleMenuClick(data, context) {
      ...
      if (props2.hideAfterItemClick) {
        var _props2$popupProps, _props2$popupProps$on;
        isPopupVisible.value = false;
        (_props2$popupProps = props2.popupProps) === null || _props2$popupProps === void 0 ? void 0 : (_props2$popupProps$on = _props2$popupProps.onVisibleChange) === null || _props2$popupProps$on === void 0 ? void 0 : _props2$popupProps$on.call(_props2$popupProps, false, context);
      }
    ...
    var handleVisibleChange = function handleVisibleChange(visible, context) {
      ...
      (_props2$popupProps2 = props2.popupProps) === null || _props2$popupProps2 === void 0 ? void 0 : (_props2$popupProps2$o = _props2$popupProps2.onVisibleChange) === null || _props2$popupProps2$o === void 0 ? void 0 : _props2$popupProps2$o.call(_props2$popupProps2, visible, context);
    };
    return function () {
      ...
      var popupParams = _objectSpread(_objectSpread(_objectSpread({}, attrs), {}, {
        ...
        overlayInnerClassName: [COMPONENT_NAME.value, (_props2$popupProps3 = props2.popupProps) === null || _props2$popupProps3 === void 0 ? void 0 : _props2$popupProps3.overlayInnerClassName]
      });
      return vue.createVNode(popup_index.Popup, vue.mergeProps(popupParams, {
        "destroyOnClose": true,
        "ref": popupElem,
