...
var getOptionsFromChildren = function getOptionsFromChildren(menuGroup) {
  var _menuGroup$0$type;
  if (!menuGroup) return [];
  if (((_menuGroup$0$type = menuGroup[0].type) === null || _menuGroup$0$type === void 0 ? void 0 : _menuGroup$0$type.name) === "TDropdownMenu") {
    var _menuGroup$, _menuGroup$$children, _menuGroup$$children$;
    var groupChildren = (_menuGroup$ = menuGroup[0]) === null || _menuGroup$ === void 0 ? void 0 : (_menuGroup$$children = _menuGroup$.children) === null || _menuGroup$$children === void 0 ? void 0 : (_menuGroup$$children$ = _menuGroup$$children["default"]) === null || _menuGroup$$children$ === void 0 ? void 0 : _menuGroup$$children$.call(_menuGroup$$children);
