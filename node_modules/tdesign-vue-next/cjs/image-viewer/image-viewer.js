...
var _ImageViewer = vue.defineComponent({
  ...
  setup: function setup(props2) {
    ...
    var transStyle = vue.computed(function () {
      return {
        transform: "translateX(-".concat(indexValue.value * 84, "px)")
      };
    });
    var renderHeader = function renderHeader() {
      return vue.createVNode("div", {
        ...
        "icon": function icon() {
          return vue.createVNode(tdesignIconsVueNext.ChevronDownIcon, {
            "size": "20px"
          }, null);
        },
        ...
        "class": "".concat(COMPONENT_NAME.value, "__bokeh-left")
      }, null), vue.createVNode("div", {
        "class": "".concat(COMPONENT_NAME.value, "__bokeh-right")
      }, null), vue.createVNode("div", {
