      ...
      return vue.createVNode(dialog_index.Dialog, {
        ...
        "header": function header() {
          return vue.createVNode("div", {
            "class": "".concat(classPrefix.value, "-image-viewer__mini-header")
          }, ["".concat(props2.index + 1, "/").concat(props2.images.length), vue.createVNode("span", {
            "class": "".concat(classPrefix.value, "-image-viewer__mini-close"),
          ...
          }, [renderJSX("closeBtn", vue.createVNode(tdesignIconsVueNext.CloseIcon, {
            "size": "1.5rem"
          }, null))])]);
        },
