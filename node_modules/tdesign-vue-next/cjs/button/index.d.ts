...
export declare const Button: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "type" | "block" | "loading" | "disabled" | "size" | "tag" | "shape" | "variant" | "theme" | "ghost">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
