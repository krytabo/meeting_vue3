...
declare const Table: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            selectedKeys?: import("../_utils/types").BaseType[] | undefined;
            defaultSelectedKeys?: import("../_utils/types").BaseType[] | undefined;
            expandedKeys?: import("../_utils/types").BaseType[] | undefined;
            defaultExpandedKeys?: import("../_utils/types").BaseType[] | undefined;
        }> & {
            onChange?: ((data: import("./interface").TableData[], extra: import("./interface").TableChangeExtra) => any) | undefined;
            onSelect?: ((rowKeys: import("../_utils/types").BaseType[], rowKey: import("../_utils/types").BaseType, record: import("./interface").TableData) => any) | undefined;
            onPageChange?: ((page: number) => any) | undefined;
            onPageSizeChange?: ((pageSize: number) => any) | undefined;
            onExpand?: ((rowKey: import("../_utils/types").BaseType, record: import("./interface").TableData) => any) | undefined;
            "onUpdate:selectedKeys"?: ((rowKeys: import("../_utils/types").BaseType[]) => any) | undefined;
            "onUpdate:expandedKeys"?: ((rowKeys: import("../_utils/types").BaseType[]) => any) | undefined;
            onExpandedChange?: ((rowKeys: import("../_utils/types").BaseType[]) => any) | undefined;
            onSelectAll?: ((checked: boolean) => any) | undefined;
            onSelectionChange?: ((rowKeys: import("../_utils/types").BaseType[]) => any) | undefined;
        ...
        $emit: ((event: "select", rowKeys: import("../_utils/types").BaseType[], rowKey: import("../_utils/types").BaseType, record: import("./interface").TableData) => void) & ((event: "change", data: import("./interface").TableData[], extra: import("./interface").TableChangeExtra) => void) & ((event: "pageChange", page: number) => void) & ((event: "pageSizeChange", pageSize: number) => void) & ((event: "expand", rowKey: import("../_utils/types").BaseType, record: import("./interface").TableData) => void) & ((event: "update:selectedKeys", rowKeys: import("../_utils/types").BaseType[]) => void) & ((event: "update:expandedKeys", rowKeys: import("../_utils/types").BaseType[]) => void) & ((event: "expandedChange", rowKeys: import("../_utils/types").BaseType[]) => void) & ((event: "selectAll", checked: boolean) => void) & ((event: "selectionChange", rowKeys: import("../_utils/types").BaseType[]) => void) & ((event: "sorterChange", dataIndex: string, direction: string) => void) & ((event: "filterChange", dataIndex: string, filteredValues: string[]) => void) & ((event: "cellClick", record: import("./interface").TableData, column: import("./interface").TableColumnData, ev: Event) => void) & ((event: "rowClick", record: import("./interface").TableData, ev: Event) => void) & ((event: "headerClick", column: import("./interface").TableColumnData, ev: Event) => void) & ((event: "columnResize", dataIndex: string, width: number) => void);
        $el: any;
        $options: import("vue").ComponentOptionsBase<Readonly<{
            ...
            select(rowKey: import("../_utils/types").BaseType | import("../_utils/types").BaseType[], checked?: boolean | undefined): void;
            expandAll(checked?: boolean | undefined): void;
            expand(rowKey: import("../_utils/types").BaseType | import("../_utils/types").BaseType[], checked?: boolean | undefined): void;
            resetFilters(dataIndex?: string | string[] | undefined): void;
            clearFilters(dataIndex?: string | string[] | undefined): void;
            resetSorters(): void;
            clearSorters(): void;
        }, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, {
            'update:selectedKeys': (rowKeys: import("../_utils/types").BaseType[]) => true;
            'update:expandedKeys': (rowKeys: import("../_utils/types").BaseType[]) => true;
            expand: (rowKey: import("../_utils/types").BaseType, record: import("./interface").TableData) => true;
            expandedChange: (rowKeys: import("../_utils/types").BaseType[]) => true;
            select: (rowKeys: import("../_utils/types").BaseType[], rowKey: import("../_utils/types").BaseType, record: import("./interface").TableData) => true;
            selectAll: (checked: boolean) => true;
            selectionChange: (rowKeys: import("../_utils/types").BaseType[]) => true;
