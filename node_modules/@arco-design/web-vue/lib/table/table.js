  ...
  setup(props, {
    ...
    const renderSummaryRow = (record, rowIndex) => {
      return vue.createVNode(tableTr, {
        ...
        "class": [`${prefixCls}-tr-summary`, is.isFunction(props.rowClass) ? props.rowClass(record, rowIndex) : props.rowClass],
    ...
    const renderContent = () => {
      if (splitTable.value) {
        ...
        return vue.createVNode(vue.Fragment, null, [props.showHeader && vue.createVNode(index, {
          "ref": theadComRef,
    ...
    const render = () => {
      ...
      return vue.createVNode("div", {
        "class": cls.value,
        "style": style.value
      }, [children.value, vue.createVNode(index$1, spinProps.value, {
